...
const registerByAdmin = async (req, res) => {
  try {
    const { name, username, password, email, isAdmin, isStaff, phoneNumber } =
      req.body;
...
const registerByUser = async (req, res) => {
  try {
...
const getAllUser = async (req, res) => {
  try {
    ...
    // const users = await UserSchema.find({ isStaff: true }).sort("__v");
